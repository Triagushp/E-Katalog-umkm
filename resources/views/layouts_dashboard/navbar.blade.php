<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
  ...
  <!-- Realtime Date Time (replace Search Bar) -->
  <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0">
    <span id="realtime-date" class="text-primary font-weight-bold"></span>
  </div>
...
<!-- Script untuk Menampilkan Tanggal & Waktu -->
<script>
  function updateDateTime() {
    ...
    document.getElementById('realtime-date').textContent = formatted;
  }
